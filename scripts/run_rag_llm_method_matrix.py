            ...
            rows.append(
                {
                    ...
                    "temporal_raw_rank_provider": retrieval_result.retrieval_timings.get("temporal_raw_rank_provider", ""),
                    "temporal_raw_rank_status": retrieval_result.retrieval_timings.get("temporal_raw_rank_status", ""),
                    "temporal_raw_rank_model": retrieval_result.retrieval_timings.get("temporal_raw_rank_model", ""),
                    "temporal_raw_rank_cache_path": retrieval_result.retrieval_timings.get("temporal_raw_rank_cache_path", ""),
                    "temporal_openai_embedding_status": retrieval_result.retrieval_timings.get("temporal_openai_embedding_status", ""),
                    "temporal_openai_embedding_complete_count": int(retrieval_result.retrieval_timings.get("temporal_openai_embedding_complete_count", 0.0)),
                    "temporal_openai_embedding_missing_count": int(retrieval_result.retrieval_timings.get("temporal_openai_embedding_missing_count", 0.0)),
                    "temporal_openai_embedding_cache_path": retrieval_result.retrieval_timings.get("temporal_openai_embedding_cache_path", ""),
                    "temporal_openai_embedding_error": retrieval_result.retrieval_timings.get("temporal_openai_embedding_error", ""),

"""Build cached OpenAI embeddings for RAG chunks."""
...
def main() -> int:
    ...
    existing_records = load_embedding_records(args.embeddings)
    ...
    write_embedding_records(args.embeddings, records)
    print(f"Wrote embeddings: {args.embeddings} ({len(records)} chunks)")
